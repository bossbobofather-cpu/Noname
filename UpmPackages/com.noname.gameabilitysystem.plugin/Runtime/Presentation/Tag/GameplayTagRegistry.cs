...
namespace Noname.GameAbilitySystem.Presentation
{
    ...
    public sealed class GameplayTagRegistry : ScriptableObject
    {
        ...
        [SerializeField] private GameplayTagContainerView _systemMessageIgnoreTags = new();
        ...
        /// </summary>
        public GameplayTagContainerView SystemMessageIgnoreTags => _systemMessageIgnoreTags;
